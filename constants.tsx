...
import { Wifi, Mic2, Layout, Sun, Zap, Coffee } from 'lucide-react';
...
export const AMENITIES: Amenity[] = [
  ...
  { icon: <Sun className="w-6 h-6" />, title: 'Mood Lighting', description: 'Advanced lighting systems to set the perfect ambiance.' },
  { icon: <Mic2 className="w-6 h-6" />, title: 'Premium AV', description: 'State-of-the-art sound and projection systems.' },
